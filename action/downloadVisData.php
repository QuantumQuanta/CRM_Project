<?php
    ...
    if (isset($_GET['data'])) {
        ...
        $visitorId = decryptData($_GET['data']);
        // echo $visitorId;
        $sql_visdata = "SELECT * FROM `visitor_log` WHERE `vis_unqidno`= '$visitorId'";
        $sql_visname = "SELECT * FROM `visitor_log_main` WHERE `vis_unq_id`='$visitorId'";
