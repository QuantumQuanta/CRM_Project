            ...
            <div class="position-relative1">
                ...
                <div class="row2">
                    ...
                    <div class="col"><label for="">Total Clients :</label>
                        ...
                        $sql_total_client = "SELECT DISTINCT `uniq_id` FROM `crm_master_table` WHERE `1st_resp`='$user_name';";
                    ...
                    <!--<div class="col"><label for="">Dead Leads :</label>
                        <?php
                        // require '../constant/db_connect.php';
                        // $sql_dead_client = "SELECT DISTINCT `uniq_id` FROM `mixed_input_proresp` WHERE `pro_name`='$user_id' AND `client_stat_1`='Number Invalid' OR 'Left The Field/Trade';";
                        // $result_dead_client = mysqli_query($conn, $sql_dead_client);
                        // $num_dead_client = mysqli_num_rows($result_dead_client);
                        ?>
                        <p id="user_dead_client" name="user_dead_client"><?php //echo $num_dead_client 
                                                                            ?></p>
                    </div>
