                ...
                <section class="chat-area">
                    <header>
                        ...
                        if (isset($_GET['chatuser_id'])) {
                            ...
                            $sql = mysqli_query($conn, "SELECT * FROM `login_data` WHERE `user`='$chatuser_id'");
                        ...
                        ?>
                        <a href="../action/chat_box.php" class="back-icon"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <form action="#" class="typing-area">
                        <input type="text" class="incoming_id" name="incoming_id" value="<?php echo $dec_incomingId; ?>" hidden>
...
<script src="../script/chat_usersMsg.js"></script>
